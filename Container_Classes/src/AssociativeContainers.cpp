...
static void printMap(const std::string& map_name, auto input_map);
static void printSet(const std::string set_name, auto input_set);
static void printMultimap(const std::string multimap_name, auto input_multimap);
